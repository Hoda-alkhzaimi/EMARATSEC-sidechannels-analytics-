# -*- coding: utf-8 -*-
"""sca_metricsSpeck.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-w2mqmvoBfHIQpfL5uBJll8cHreege-3
"""
...
class SCAMetrics:       #s box
    ...
    def ge_and_sr(self, runs, model, param, leakage_model, byte, x_test, test_trace_data, step, fraction):
        ...
        for key_byte_hypothesis in range(0, 256): #loop is running 256 times => number of classes
            ...
            #labeling is done for all nt at once i.e. all traces. key-by-key #key_h goes fron 0 ->256 and labelize works on this (testing process)
        # ---------------------------------------------------------------------------------------------------------#
        # predict output probabilities for shuffled test or validation set
        # ---------------------------------------------------------------------------------------------------------#
        output_probabilities = model.predict(x_test) #predict the label for all x_test. Model is passed after fitting/defining from (C)NN
        ...
        for index in range(nt):
            ...
            ]         #leakage: imagine pillars of nt units and each is 256 in length. leakage[index] is 1 unit of nt
                      #array has labels from key hypothesis
